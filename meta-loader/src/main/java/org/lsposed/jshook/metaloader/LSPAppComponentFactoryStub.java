package org.lsposed.jshook.metaloader;
...
public class LSPAppComponentFactoryStub extends AppComponentFactory {
    ...
    private static final String TAG = "JsHook-MetaLoader";
    ...
    static {
        try {
            ...
            soPath = cl.getResource("assets/jshook/so/" + libName + "/libjshook.so").getPath().substring(5);
